...
template = {
    "omnetpp": 786625, "lbm": 646983, "mcf": 785109, "perlbench": 394934, "namd": 958511, 
...
fingerprinting_data = open("ceaser.log").readlines()
...
print("(CEASER) Accuracy: {acc}".format(acc=correct / total))
