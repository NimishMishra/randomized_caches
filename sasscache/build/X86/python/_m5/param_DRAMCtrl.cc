...
module_init(py::module &m_internal)
{
    ...
    py::class_<DRAMCtrlParams, QoSMemCtrlParams, std::unique_ptr<DRAMCtrlParams, py::nodelete>>(m, "DRAMCtrlParams")
        .def(py::init<>())
    ...
    py::class_<DRAMCtrl, QoS::MemCtrl, std::unique_ptr<DRAMCtrl, py::nodelete>>(m, "DRAMCtrl")
        ;

}

static EmbeddedPyBind embed_obj("DRAMCtrl", module_init, "QoSMemCtrl");
