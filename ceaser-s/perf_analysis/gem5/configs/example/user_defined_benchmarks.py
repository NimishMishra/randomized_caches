...
def create_process(benchmark_name):    
    ...
    if benchmark_name == 'perlbench':
        ...
        print("--> deepsjeng")
        process = spec06_benchmarks.deepsjeng
    elif benchmark_name == "cactu":
        print("--> cactuBSSN")
        process = spec06_benchmarks.cactu
    elif benchmark_name == "x264":
        print("--> x264")
        process = spec06_benchmarks.x264
    elif benchmark_name == "blender":
        print("--> blender")
        process = spec06_benchmarks.blender
    elif benchmark_name == "imagick":
        print("--> imagick")
        process = spec06_benchmarks.imagick
    elif benchmark_name == "leela":
        print("--> leela")
        process = spec06_benchmarks.leela
    elif benchmark_name == "nab":
        print("--> nab")
        process = spec06_benchmarks.nab
    elif benchmark_name == "fotonik":
        print("--> fotonik")
        process = spec06_benchmarks.fotonik
    elif benchmark_name == "xz":
        print("--> xz")
        process = spec06_benchmarks.xz
    ######### SPEC 2017 benchmarks #######
