...
class Simulator(object):
    ...
    def run_simulation(self, num_blocks_per_set, num_words_per_block, cache_size, num_partitions, replacement_policy, num_addr_bits, word_addrs, num_of_victim_access):
        num_blocks = (cache_size // 32) // num_words_per_block
